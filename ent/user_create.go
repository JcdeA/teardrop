...
// SetCreateAt sets the "create_at" field.
func (u *UserUpsert) SetCreateAt(v time.Time) *UserUpsert {
...
// SetCreateAt sets the "create_at" field.
func (u *UserUpsertOne) SetCreateAt(v time.Time) *UserUpsertOne {
	return u.Update(func(s *UserUpsert) {
		s.SetCreateAt(v)
	})
}
...
// SetCreateAt sets the "create_at" field.
func (u *UserUpsertBulk) SetCreateAt(v time.Time) *UserUpsertBulk {
	return u.Update(func(s *UserUpsert) {
		s.SetCreateAt(v)
	})
}
